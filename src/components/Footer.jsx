...
const Footer = () => {
  return (
    <div className="w-full flex gap-5 h-screen bg-zinc-900 p-20 font-['Founders_Grotesk_Medium']">
      <div className="w-1/2 h-full flex flex-col justify-between">
        <div className="heading">
          <h1 className="text-[10vh] leading-none font-semibold uppercase -mb-3">
            eye-
          </h1>
          <h1 className="text-[10vh] leading-none font-semibold uppercase -mb-10">
            opening
          </h1>
        </div>
        <svg
      ...
      <div className="w-1/2">
        <h1 className="text-[8vh] leading-none font-semibold uppercase -mb-3">
          Presentations
        </h1>
        <div className="dets font-['Founders_Grotesk_Medium'] mt-10">
